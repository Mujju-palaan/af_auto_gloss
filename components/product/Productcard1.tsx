...
const Productcard1 = () => {
  return (
    ...
    Product1.map((item, idx) => (
      <section key={idx} className="text-gray-600 body-font overflow-hidden">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mb-4">
                <span className="flex items-center">
                  <svg fill="currentColor" stroke="currentColor" strokeLinecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 text-red-500" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-600 ml-3">{item.reviews}</span>
                </span>
              ...
              <p className="leading-relaxed">{item.product_description}</p>
