          ...
          {roadmapData.map((item, index) => {
            ...
            return (
              ...
              >
                {/* Content box */}
                <div
                  className={`w-full md:w-5/12 bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all ${isLeft ? "text-right pr-10 md:mr-10" : "text-left pl-10 md:ml-10"}`}
                >
                  <div className="flex items-center gap-3 mb-2">
                    <div
                      className={`flex items-center justify-center w-10 h-10 rounded-full ${item.color} shadow-lg`}
                    >
                      {item.icon}
                    </div>
