          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-20">
              ...
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base pb-4">
                At AF Auto Gloss, we are committed to delivering premium-quality car care products, including Dashboard Polish, Tyre Polish, Glass Cleaner, Foam, and Microfiber Car Cloth. Your satisfaction is our top priority, and we have established this refund policy to ensure a seamless experience for our valued customers.              
              </p>
