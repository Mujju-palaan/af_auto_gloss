  ...
  return (
    <div className="bg-gray-50 py-16 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-3xl font-semibold text-gray-900 mb-6">Terms & Conditions</h1>
        <p className="text-gray-700 mb-6">Last Updated: 23rd Sep, 2025</p>
        <p className="text-gray-700 mb-6">
          Welcome to AF AUTO GLOSS. By accessing or purchasing from our website, you agree to comply with the following Terms & Conditions. Please read them carefully, as they govern your use of our products and services.              </p>
