const ServiceData = [
  {
    id: 1,
    image: "/service/afautogloss-service-Manufacturing.png",
    title: "Manufacturing of Auto Care Products",
    slug: "auto-care-product-manufacturing",
    description: (
      <>
        ...
        ensure consistent, showroom-quality results.
      </>
    ),
    bestFor: [
      "Auto care brands",
      ...
      "Professional detailing businesses",
      "Automotive service providers",
    ],
  },
  {
    id: 2,
    image: "/service/afautogloss-service-B2B.png",
    title: "Bulk Supply for Dealers & Workshops (B2B)",
    slug: "bulk-supply-b2b",
    description: (
      <>
  ...
  {
    id: 3,
    image: "/service/afautogloss-service-B2C.png",
    title: "Supply to Car Wash & Detailing Units (B2C)",
    slug: "supply-b2c-car-wash-detailing",
    description: (
      <>
    ...
    bestFor: [
      ...
      "Independent detailing professionals",
      "Retail auto care users",
    ],
  },
];
